...
import GridFilter from 'griddle-react/modules/gridFilter.jsx';
import GridPagination from 'griddle-react/modules/gridPagination.jsx';
import GridSettings from 'griddle-react/modules/gridSettings.jsx';
import GridNoData from 'griddle-react/modules/gridNoData.jsx';
import GridRow from './GriddleRow';
import GridRowContainer from 'griddle-react/modules/gridRowContainer.jsx';
import CustomRowComponentContainer from 'griddle-react/modules/customRowComponentContainer.jsx';
import CustomPaginationContainer from 'griddle-react/modules/customPaginationContainer.jsx';
import CustomFilterContainer from 'griddle-react/modules/customFilterContainer.jsx';
import ColumnProperties from 'griddle-react/modules/columnProperties';
import RowProperties from 'griddle-react/modules/rowProperties';
import deep from 'griddle-react/modules/deep';

import drop from 'lodash/drop';
import dropRight from 'lodash/dropRight';
import find from 'lodash/find';
import first from 'lodash/take';
...
class Griddle extends React.Component {
    ...
    static GridFilter = GridFilter;
    static GridPagination = GridPagination;
    static GridSettings = GridSettings;
    static GridRow = GridRow;
    ...
    getDataForRender(data, cols, pageList) {
        var _this = this;
    ...
    getFilter() {
        return this.props.showFilter && this.shouldUseCustomGridComponent() === false ? this.props.useCustomFilterComponent ? React.createElement(CustomFilterContainer, {
    ...
    getPagingSection(currentPage, maxPage) {
        ...
        return React.createElement('div', {className: 'griddle-footer'}, this.props.useCustomPagerComponent ? React.createElement(CustomPaginationContainer, {
            customPagerComponentOptions: this.props.customPagerComponentOptions,
            next: this.nextPage,
    ...
    getColumnSelectorSection(keys, cols) {
        return this.state.showColumnChooser ? React.createElement(GridSettings, {
            ...
            useCustomComponent: this.shouldUseCustomRowComponent() || this.shouldUseCustomGridComponent(),
            useGriddleStyles: this.props.useGriddleStyles,
    ...
    getCustomRowSection(data, cols, meta, pagingContent, globalData) {
        return React.createElement('div', null, React.createElement(CustomRowComponentContainer, {
            data: data, columns: cols, metadataColumns: meta, globalData: globalData,
    ...
    getContentSection(data, cols, meta, pagingContent, hasMorePages, globalData) {
        ...
        } else if (this.props.useCustomBody !== false && this.shouldUseCustomRowComponent()) {
...
GridRowContainer.Griddle = Griddle;
